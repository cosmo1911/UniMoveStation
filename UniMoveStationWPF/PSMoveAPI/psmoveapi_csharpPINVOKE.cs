...
namespace io.thp.psmove
{
    ...
    class pinvoke
    {
        ...
        public static extern void psmove_get_accelerometer(HandleRef move, out int x, out int y, out int z);

        [DllImport("libpsmoveapi_csharp", EntryPoint = "CSharp_psmove_get_gyroscope@16")]
        public static extern void psmove_get_gyroscope(HandleRef move, out int x, out int y, out int z);

        [DllImport("libpsmoveapi_csharp", EntryPoint = "CSharp_psmove_get_magnetometer@16")]
        public static extern void psmove_get_magnetometer(HandleRef move, out int x, out int y, out int z);
        ...
        public static extern PSMoveConnectionType PSMove_connection_type_get(HandleRef move);
        ...
        [DllImport("libpsmoveapi_csharp", EntryPoint = "CSharp_psmove_enable_orientation@8")]
        public static extern void PSMove_enable_orientation(HandleRef move, PSMoveBool enabled);

        [DllImport("libpsmoveapi_csharp", EntryPoint = "CSharp_psmove_has_orientation@4")]
        public static extern PSMoveBool PSMove_has_orientation(HandleRef jarg1);

        [DllImport("libpsmoveapi_csharp", EntryPoint = "CSharp_psmove_has_calibration@4")]
        public static extern PSMoveBool PSMove_has_calibration(HandleRef jarg1);
        ...
        [DllImport("libpsmoveapi_csharp", EntryPoint = "CSharp_psmove_get_battery@4")]
        public static extern PSMoveBatteryLevel PSMove_get_battery(HandleRef jarg1);
        ...
        public static extern void psmove_tracker_set_auto_update_leds(HandleRef tracker, HandleRef move, int jarg3);
        ...
        public static extern void psmove_tracker_set_exposure(HandleRef tracker, PSMoveTrackerExposure exposure);
        ...
        public static extern PSMoveTrackerStatus PSMoveTracker_enable_with_color(HandleRef tracker, HandleRef move, int jarg3, int jarg4, int jarg5);
        ...
        public static extern void PSMoveTracker_set_auto_update_leds(HandleRef tracker, HandleRef move, PSMoveBool autoUpdateLeds);

        [DllImport("libpsmoveapi_csharp", EntryPoint = "CSharp_PSMoveTracker_get_auto_update_leds@8")]
        public static extern PSMoveBool PSMoveTracker_get_auto_update_leds(HandleRef jarg1, HandleRef jarg2);
