...
namespace UniMoveStation.Business.CLEyeMulticam
{
    public class CLEyeCameraImage : Image, IDisposable
    {
        ...
        {
            get { return (CLEyeCameraDevice)GetValue(DeviceProperty); }
            set { SetValue(DeviceProperty, value); }
        }

        public static readonly DependencyProperty DeviceProperty =
            DependencyProperty.Register("Device", typeof(CLEyeCameraDevice), typeof(CLEyeCameraImage),
            new UIPropertyMetadata(default(CLEyeCameraDevice), delegate(DependencyObject sender, DependencyPropertyChangedEventArgs e)
            {
                CLEyeCameraImage typedSender = sender as CLEyeCameraImage;
                typedSender.Device = (CLEyeCameraDevice)e.NewValue;
            }));
        ...
        public static readonly DependencyProperty FramerateProperty =
            ...
            new UIPropertyMetadata((float)15, delegate(DependencyObject sender, DependencyPropertyChangedEventArgs e)
            {
                CLEyeCameraImage typedSender = sender as CLEyeCameraImage;
        ...
        public static readonly DependencyProperty ColorModeProperty =
            ...
            new UIPropertyMetadata(default(CLEyeCameraColorMode), delegate(DependencyObject sender, DependencyPropertyChangedEventArgs e)
            {
                CLEyeCameraImage typedSender = sender as CLEyeCameraImage;
        ...
        public static readonly DependencyProperty ResolutionProperty =
            ...
            new UIPropertyMetadata(default(CLEyeCameraResolution), delegate(DependencyObject sender, DependencyPropertyChangedEventArgs e)
            {
                CLEyeCameraImage typedSender = sender as CLEyeCameraImage;
